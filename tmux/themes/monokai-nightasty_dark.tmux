...
set -g mode-style "fg=$tm_magenta,bg=$tm_bg"

set -g message-style "fg=$tm_orange,bg=$tm_bg_highlight"
set -g message-command-style "fg=$tm_magenta,bg=$tm_bg"
...
set -g status-style "fg=$tm_magenta,bg=$tm_bg_highlight"
...
tm_session="#[fg=$tm_black,bg=$tm_magenta,bold] #S"
tm_left_arrow="#[fg=$tm_magenta,bg=$tm_bg_highlight]"
tm_clock_24="#[fg=$tm_bg,bg=$tm_bg_highlight]#[fg=$tm_magenta,bg=$tm_bg]  %H:%M"
tm_clock_12="#[fg=$tm_bg,bg=$tm_bg_highlight]#[fg=$tm_magenta,bg=$tm_bg]  %I:%M %p"
tm_host="#[fg=$tm_black,bg=$tm_magenta,bold] #h "
tm_right_green_to_grey_sep="#[fg=$tm_bg_highlight,bg=$tm_bg]#[fg=$tm_magenta,bg=$tm_bg_highlight]"
...
tm_win_active="#[fg=$tm_magenta,bg=$tm_bg,bold] #I#W "
